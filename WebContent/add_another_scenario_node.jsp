                ...
                <td bgcolor="white" >
                    ...
                    <%
                       ...
                       /*  try {
                            ...
                            out.println("Add node information for scenario " + scenario_desc + " of building: " + building_name);
                            /* building_name = building_name.replace(" ", "_"); */
                    %>    
                    ...
                    <b> Nodes Present earlier for Scenario: <%out.println(" " + scenario_desc);%></b>
                </td></tr></table>

        <table border="1" cellpadding="5" cellspacing="5" width="10%">    
                <tr><td>Scenario Id</td><td>Node Id</td><td>Scenario Description</td><td>Node Type</td><td>Fit People</td><td>Injured people</td><td>Rescuers</td><td>Danger level</td><td>Priority</td></tr>     
            <%
                String query1 = "select * from scenario_node where building_name = '"+building_name+"' and scenario_name= '"+scenario_name+"'";
                rs = s.executeQuery(query1);
                while (rs.next()) {
            %>
            <tr><td> <% out.println(rs.getInt(3));%> </td><td> <% out.println(rs.getString(4));%> </td><td> <% out.println(rs.getString(5));%> </td><td> <% out.println(rs.getString(6));%> </td><td> <% out.println(rs.getInt(7));%> </td><td> <% out.println(rs.getInt(8));%> </td><td> <% out.println(rs.getInt(9));%> </td><td> <% out.println(rs.getInt(10));%> </td><td> <% out.println(rs.getInt(11));%> </td></tr>
            <%
                }
            %>
        </table>
