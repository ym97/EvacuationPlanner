...
<body onFocus="parent_disable();" onclick="parent_disable();">
	...
	String run_id=session.getAttribute("run_id").toString();
	%> --%>
	<div id="wide">
		...
		<%}
				...
				/* 	 setTimeout(
					 ...
					 */			//popupPath.close();
							...
							/* for (i = 0; i < the_nodes.length; i++) {
									//alert(the_nodes[i])
									d3.select("#" + the_nodes[i]).style("fill",
											"blue");
								fpopup
								}
								for (i = 0; i < the_paths.length; i++) {
									//alert(the_paths[i])
									d3.select("#" + the_paths[i]).style(
											"stroke", "blue");
								} */
