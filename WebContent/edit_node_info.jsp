            ...
            <tr>
                ...
                <td bgcolor="white">
                    ...
                    <table border="1" cellpadding="5" cellspacing="5" width="10%">    
                        <tr><td>Node ID</td><td>Node Name</td><td>Actual Capacity</td><td>Initial Capacity</td><td>Ladder placement</td></tr>    
                        <%
                            String building_name = request.getParameter("building_name");
                            //System.out.println("Hello");
                            try {
                                String ss = getServletContext().getRealPath("") + "/" + building_name + "_Static_Node_data";
                                File s1 = new File(ss);
                                s1.delete();
