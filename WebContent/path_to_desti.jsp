...
<html>
    ...
    <table border="0" cellpadding="5" cellspacing="5" align="center">
        <%
            ...
            String desti_name = request.getParameter("desti_name");
            ...
            try {
                ...
                String q1 = "Select * from EvacRun_Path where run_id ="+run_id+" and destination ='"+desti_name+"'"; // building_name = '" + building_name + "' and scenario_name = '"+scenario_name+"' ";
