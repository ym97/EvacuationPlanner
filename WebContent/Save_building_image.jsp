...
<%
    ...
    if (!isMultipart) {
        ...
        while (itr.hasNext()) {
            ...
            if (item.isFormField()) {
                if (item.getFieldName().equals("buildingName")) {
                	building_name = item.getString();
                 } else if (item.getFieldName().equals("floors")) {
                    floors = item.getString();
            ...
            if (fileItem != null) {
                if (fileItem.getSize() > 0) {
                    if (optionalFileName1.trim().equals("")) //fileName = FilenameUtils.getName(fileName);
                    {
                      	 ...
                      	 file_name1 = building_name +"_Floor_plan.png";
                      	 System.out.println("file_name1 is : " + file_name1+" buildingName "+building_name);
        ...
        <table border="0" cellpadding="5" cellspacing="5" align="center">
            <tr>
                ...
                <td bgcolor="white">   
                    ...
                    System.out.println("file name for testinggggg :" +building_name);
                        if (fi.exists()) {
                    %>
                 				   <%-- <input type="hidden" name="building_name" value = <% out.println(buildingName);%>/>
                                    <input type="hidden" name="floors" value = <% out.println(floors);%>/>            
                                    <input type="hidden" name="description" value = <% out.println(description);%>/> --%>
                                     ...
                                     String redirectURL = "input_files.jsp";
