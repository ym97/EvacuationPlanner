...
<body>
<div id="title">
  <div id="title1">What ever you need</div>
</div>
<div id="main1">
  <ul id="menu2">
    <li><a href="#" class="drop">Home</a>
      ...
      <div class="dropdown_2columns">
        ...
        <div class="col_2">
          <p><a href="new.jsp">Link to jsp</a></p><p>Hi and welcome here ! This is a showcase of the possibilities of this awesome Mega Drop Down Menu.</p>
    ...
    <!-- End 3 columns Item -->
      ...
      <font size="4"><b>Register New Building:</b></font>
...
<center>
	...
	<table>
            <tr>
                <td><front color="white">Building Name</td> 
                <td><input type="text" name="userName"></input></td>
            </tr>
            <tr>
                <td><front color="white">Description</td> 
        ...
        <!--<font color="red">If there is no data file, enter the data with 'add node', 'add edge' <a href="edit_data.jsp"><font color="red">option</font></a>.</font>-->
	
</center>       
</center>
<a href="Application.jsp"><font color="black"><b> Back </b></font></a>
