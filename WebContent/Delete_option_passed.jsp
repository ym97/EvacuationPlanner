                       ...
                       <!--  <select name="building_name" id="building_name"> -->
                            ...
                            connectionString cs = new connectionString();
                                ...
                                try {
                                    ...
                                    String q1 = "Delete from buildings where building_name='"+building_name+"' and creator = '"+session.getAttribute("uName")+"'";
                                    int rows = (s.executeUpdate(q1));
                                   	if(rows<=0)
                                    	%>
                                    	<input type="hidden" value="Err" name="Err">
                                    	<%
                                    rs.close();
                                    s.close();
                                    con.close();
                                ...
                                String redirectURL = "Delete_Build.jsp";
