<%-- 
shows all the options in dropdown List 
...
<html>
    ...
    <u><a href="building_created.jsp" target="f2" >Home</a></u> > 
     ...
     <u><a href="view_ladderplacement_data.jsp" target="f2">View ladderplacement data</a></u> > 
     View ladderplacement nodes
        <table border="0" cellpadding="5" cellspacing="5" width="100%">
            <tr>
                ...
                <td bgcolor="white">
                    ...
                    <form method="post" action="display_ladderplacement_nodes.jsp">
                        <table><tr><td>        
